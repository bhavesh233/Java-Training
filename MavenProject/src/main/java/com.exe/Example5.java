...
public class Example5 {
    ...
    public static void main(String[] args) {
        ...
        Logger logger = LoggerFactory.getLogger(Example5.class);
        ...
        arrayList.forEach(s -> { ProminentTrainee p = s;
            System.out.println(p.TraineeId + " " + p.TraineeName + " " + p.TraineeDOB + " " + p.TraineeAge);
        });
        System.out.println();
        ...
        // convert HashMap
//        logger.info("Convert ArrayList to HashMap");
        ...
        for (
                ProminentTrainee p : arrayList) {
            logger.warn(p.TraineeId + " " + p.TraineeName + " " + p.TraineeDOB + " " + p.TraineeAge);
        }
        System.out.println();
